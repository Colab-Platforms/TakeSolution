...
const Disclosure = () => {
  ...
  const disclosureData = {
    FY26: [
      { type: 'Other Disclosures', date: '17-Feb-26', description: 'Press Release - TAKE Solutions to build a Scalable Unified AI Platform, aligning with the IndiaAI Mission to Transform the USD 370 billion National Healthcare Ecosystem.', link: '/assets/investordata/disclosure/disclosure-data/PR Scalable Unified AI Platform.pdf' },
      ...
      { type: 'Other Disclosures', date: '12-Dec-25', description: 'Disclosure under Regulation 30 of the SEBI (Listing Obligations and Disclosure Requirement) Regulations, 2015 – Appointment of Mr. Parmeshvar Namdev Dhangare as Non‐Executive Non‐ Independent Director of the Company', link: '/assets/investordata/disclosure/disclosure-data/Reg 30.pdf'},
      { type: 'Other Disclosures', date: '30-Oct-25', description: 'Reconciliation of Share Capital Audit Report — Quarter ended September 30, 2025', link: '/assets/investordata/disclosure/disclosure-data/Reg76_30092025_TSL.pdf' },
      { type: 'Other Disclosures', date: '28-Oct-25', description: 'Newspaper Publication', link: '/assets/investordata/disclosure/disclosure-data/NewspaperIntimation_28102025.pdf' },
      { type: 'Other Disclosures', date: '27-Oct-25', description: 'Outcome of the Board Meeting held on Monday, October 27, 2025', link: '/assets/investordata/disclosure/disclosure-data/Reg30_Outcome_BM_27102025_TSL.pdf' },
      { type: 'Other Disclosures', date: '22-Oct-25', description: 'Notice of Board Meeting', link: '/assets/investordata/disclosure/disclosure-data/Reg29_Intimation_BM_22102025_TSL.pdf' },
      { type: 'Other Disclosures', date: '10-Oct-25', description: 'Certificate pursuant to Regulation 74(5) of SEBI (Depositories and Participants) Regulations 2018', link: '/assets/investordata/disclosure/disclosure-data/Reg74(5)_10102025_TSL.pdf' },
      { type: 'Other Disclosures', date: '09-Oct-25', description: 'Intimation regarding resignation of Statutory Auditor of the Company', link: '/assets/investordata/disclosure/disclosure-data/INTIMATION_REG_30_AUDITOR_RESIGNATION_TSL.pdf' },
      { type: 'Other Disclosures', date: '03-Oct-25', description: 'Scrutinizer’s Report and Voting Results of the Twenty Fourth Annual General Meeting', link: '/assets/investordata/disclosure/disclosure-data/Scrutinizer_Report_AGM_30092025_TSL.pdf' },
      { type: 'Other Disclosures', date: '30-Sep-25', description: 'Summary of proceedings of the Twenty Fourth Annual General Meeting', link: '/assets/investordata/disclosure/disclosure-data/AGM_Proceedings_2025.pdf'},
      { type: 'Other Disclosures', date: '30-Sep-25', description: 'Closure of Trading Window', link: '/assets/investordata/disclosure/disclosure-data/TradingWindowClosure_30092025.pdf' },
      { type: 'Other Disclosures', date: '26-Sep-25', description: 'Intimation for disinvestment of M/s. Take Consultancy Services Inc, wholly owned subsidiary', link: '/assets/investordata/disclosure/disclosure-data/Reg30_Disinvestment_TCS-Inc_260925.pdf' },
      { type: 'Other Disclosures', date: '17-Sep-25', description: 'Newspaper Publication', link: '/assets/investordata/disclosure/disclosure-data/Reg47_Intimation_Newspaper_TSL_170925.pdf' },
      { type: 'Other Disclosures', date: '08-Sep-25', description: 'Newspaper Publication', link: '/assets/investordata/disclosure/disclosure-data/NewspaperIntimation_08092025.pdf' },
      { type: 'Annual Disclosures', date: '06-Sep-25', description: 'Submission of Annual Report - FY 2024-25', link: '/assets/investordata/disclosure/disclosure-data/AR_Submission_06092025_TSL.pdf' },
      ...
      { type: 'Other Disclosures', date: '30-Jul-25', description: 'Reconciliation of Share Capital Audit Report - Quarter ended June 3, 2025.', link: '/assets/investordata/disclosure/disclosure-data/Reg76_30062025_TSL.pdf' },
      { type: 'Other Disclosures', date: '30-Jul-25', description: 'Summary of proceedings of the Extra-Ordinary General Meeting', link: '/assets/investordata/disclosure/disclosure-data/EGM_Proceedings_2025.pdf' },
      { type: 'Other Disclosures', date: '21-Jul-25', description: 'Newspaper Publication', link: '/assets/investordata/disclosure/disclosure-data/Reg47_Intimation_Newspaper_TSL.pdf' },
      { type: 'Other Disclosures', date: '14-Jul-25', description: 'Certificate pursuant to Regulation 74(5) of SEBI (Depositories and Participants) Regulations 2018.', link: '/assets/investordata/disclosure/disclosure-data/Reg74(5)_14072025_TSL.pdf' },
      { type: 'Other Disclosures', date: '09-Jul-25', description: 'Newspaper Publication', link: '#' },
      { type: 'Other Disclosures', date: '08-Jul-25', description: 'Notice of Extra-Ordinary General Meeting', link: '/assets/investordata/disclosure/disclosure-data/Intimation_EGM_Notice_TSL.pdf' },
      { type: 'Other Disclosures', date: '08-Jul-25', description: 'Newspaper Publication', link: '/assets/investordata/disclosure/disclosure-data/NewspaperIntimation-08-jul-25.pdf' },
      { type: 'Other Disclosures', date: '07-Jul-25', description: 'Outcome of the Board Meeting held on Monday, July 7, 2025.', link: '/assets/investordata/disclosure/disclosure-data/Reg30_Outcome_BM_07072025_TSL.pdf' },
      { type: 'Other Disclosures', date: '02-Jul-25', description: 'Notice of Board Meeting', link: '/assets/investordata/disclosure/disclosure-data/Reg 29_Intimation_BM_02072025_TSL.pdf' },
      { type: 'Other Disclosures', date: '27-Jun-25', description: 'Closure of trading window', link: '/assets/investordata/disclosure/disclosure-data/TradingWindowClosure_30062025.pdf' },
      { type: 'Other Disclosures', date: '02-Jun-25', description: 'Newspaper Publication', link: '/assets/investordata/disclosure/disclosure-data/NewspaperIntimation-02-06-2025.pdf' },
      { type: 'Other Disclosures', date: '30-May-25', description: 'Annual Secretarial Compliance Report of the Company for the year ended March 31, 2025', link: '/assets/investordata/disclosure/disclosure-data/Reg24A_ASCR_30052025_TSL.pdf' },
